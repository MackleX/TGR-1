...
phone_reviews.to_csv('Data Science/Tech-Gadgets-Recommendation/Datasets/phone_reviews.csv', sep=',', index = False)

phone_reviews = pd.read_csv('Data Science/Tech-Gadgets-Recommendation/Datasets/phone_reviews.csv')
