...
review="I've got a big family and I wanna get a good living room SmartTV. So needless to say I'd like its size to be quite big. Although I ain't looking for state of the art resolution, it's gotta absolutely have vibrant colors"
...
def Classify_and_stats(review):
    ...
    for s in blob.sentences:
        ...
        output.append({i+1: sentence,
        'aspects' : aspects[i],
        'description' : description[i],
        'stats': s.sentiment,
        'classify' : s.classify()},)
        i+=1
    print("\nthe user text is: "+review+"\n")
    for x in output:
        print(x, end="\n\n")
    return output
...
print(keywords_extraction(review))
Classify_and_stats(review)
